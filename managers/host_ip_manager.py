...
class HostIPManager:
    ...
    def store_host_ip(self) -> Dict[str, str] | None:
        ...
        # smartshield, then it will get stuck in a loop here until it's abl to
        # get the host ip
