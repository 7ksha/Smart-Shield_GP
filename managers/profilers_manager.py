...
class ProfilersManager:
    ...
    def cpu_profiler_init(self):
        ...
        from smartshield_files.common.performance_profilers.cpu_profiler import (
            CPUProfiler,
        )
        ...
        try:
            if (
                ...
                # reaching here means smartshield is now running using the viztracer
                # command
    ...
    def memory_profiler_init(self):
        ...
        from smartshield_files.common.performance_profilers.memory_profiler import (
            MemoryProfiler,
        )
