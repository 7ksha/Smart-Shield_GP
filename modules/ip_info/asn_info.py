...
class ASN:
    ...
    def get_asn_online(self, ip):
        ...
        try:
            ...
            # comes here if smartshield fails to get the as info from the response
            # OR gets it correctly, but the info doesn't contain the fields smartshield sis expecting
            pass
