...
class Redis {
  ...
  getAllProfiles() {
    return new Promise((resolve, reject) => {
      this.db.smembers("profiles", (err, reply) => {
  ...
  getProfileTWs(key) {
    return new Promise((resolve, reject) => {
      this.db.zrange(key, 0, -1, (err, reply) => {
  ...
  getBlockedIPsTWs() {
    return new Promise((resolve, reject) => {
      this.db.hgetall("BlockedProfTW", (err, reply) => {
  ...
  getHostIP() {
    return new Promise((resolve, reject) => {
      this.db.smembers('hostIP', (err, value) => {
  ...
  getHostnameOfIP(profileid) {
    return new Promise((resolve, reject) => {
      this.db.hmget(profileid, 'host_name', (err, value) => {
        if (err) { console.log(err); reject(err); }
        else {
          resolve(value[0]);
        }
  ...
  getTimeline(ip, timewindow) {
    return new Promise((resolve, reject) => {
      this.db.zrange("profile_" + ip + "_" + timewindow + '_timeline', 0, -1, (err, reply) => {
  ...
  getEvidence(ip, timewindow) {
    return new Promise((resolve, reject) => {
      this.db.hget("profile_" + ip + "_" + timewindow, 'Evidence', (err, reply) => {
  ...
  getDNSResolution(ip) {
    return new Promise((resolve, reject) => {
      ...
      this.db.hget('DNSresolution', ip, (err, value) => {
        if (err) {
          console.log('Error in getDNSResolution() in kalipso_redis.js. Error: ', err);
          reject(resolved_dns)
        }
        else {
          if (value == null) { value = '' }
  ...
  getIpInfo(ip) {
    return new Promise((resolve, reject) => {
      this.cache.hget("IPsInfo", ip, (err, reply) => {
  ...
  getOutTuples(ip, timewindow) {
    return new Promise((resolve, reject) => {
      this.db.hget("profile_" + ip + "_" + timewindow, 'OutTuples', (err, reply) => {
  ...
  getInTuples(ip, timewindow) {
    return new Promise((resolve, reject) => {
      this.db.hget("profile_" + ip + "_" + timewindow, 'InTuples', (err, reply) => {
  ...
  getUDPest(ip, timewindow, udp_key) {
    return new Promise((resolve, reject) => {
      this.db.hget("profile_" + ip + "_" + timewindow, udp_key, (err, reply) => {
  ...
  getTCPest(ip, timewindow, tcp_key) {
    return new Promise((resolve, reject) => {
      this.db.hget("profile_" + ip + "_" + timewindow, tcp_key, (err, reply) => {
  ...
  getAllProfileEvidences(ip) {
    return new Promise(
      (resolve, reject) => {
        this.db.hgetall("evidenceprofile_" + ip, (err, reply) => {
  ...
  /*Get all smartshield processes PIDs.*/
  getPIDs() {
    return new Promise(
      (resolve, reject) => {
        this.db.hgetall("PIDs", (err, reply) => {
  ...
  getStarttimeForTW(ip, timewindow) {
    return new Promise((resolve, reject) => {
      this.db.zscore("twsprofile_" + ip, timewindow, (err, reply) => {
