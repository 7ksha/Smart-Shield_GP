...
class ThreatIntel(IModule, URLhaus, Spamhaus):
    ...
    def set_evidence_malicious_domain(
        ...
        # when we comment ti_files and run smartshield, we
        ...
        if domain_resolution:
            ...
            evidence = Evidence(
                ...
                timewindow=TimeWindow(number=twid_number),
                uid=[uid],
                timestamp=utils.convert_ts_format(
    ...
    def is_inbound_traffic(self, ip: str, ip_state: str) -> bool:
        ...
        """
        # if smartshield was monitoring multiple interfaces, it'd have multiple
        # host ips
    ...
    def ip_belongs_to_blacklisted_range(
        ...
        # Malicious IP ranges are stored in smartshield sorted by the first octet
    ...
    def should_lookup(self, ip: str, protocol: str, ip_state: str) -> bool:
        """Return whether smartshield should lookup the given ip or not."""
    ...
    def is_dns_answer_of_a_malicious_query(
        ...
        even if the IPs returned in the answer is not in one of smartshield' TI feeds.
