...
class BaseModel:
    ...
    from this class are requested by the main module process on behalf on
     smartshield, when smartshield wants to know the network's
    ...
    def __init__(self, logger: Output, trustdb, main_smartshield_db: DBManager):
        self.trustdb = trustdb
        self.main_smartshield_db = main_smartshield_db
    ...
    def compute_peer_trust(
        ...
        level
        :param score: score by smartshield for the peer's IP address
        :param confidence: confidence by smartshield for the peer's IP address
    ...
    def assemble_peer_opinion(self, data: list) -> (float, float, float):
        ...
        :param data: a list of peers and their reports, in the format given
         ...
         (
            ...
            reporter_score, # what does smartshield think about the reporter's ip
            # how confident smartshield is about the reporter's ip's score
            reporter_confidence,
            reporter_ipaddress,
        )
        :return: average peer reputation, final score and final confidence
        ...
        for peer_report in data:
            (
                ...
                report_confidence,
                reporter_reliability,
                # what does smartshield think about the reporter's ip
                reporter_score,
                # how confident smartshield is about the reporter's ip's score
                reporter_confidence,
                reporter_ipaddress,
            ...
            self.main_smartshield_db.set_peer_trust(reporter_ipaddress, peer_trust)
