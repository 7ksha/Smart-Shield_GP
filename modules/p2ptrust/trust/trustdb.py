...
from smartshield_files.common.abstracts.isqlite import ISQLite
...
class TrustDB(ISQLite):
    ...
    def insert_smartshield_score(
        ...
        query = """
            INSERT OR REPLACE INTO smartshield_reputation
    ...
    def get_reporter_reputation(self, reporter_ipaddress):
        ...
        """
        res = self.select(
            table_name="smartshield_reputation",
