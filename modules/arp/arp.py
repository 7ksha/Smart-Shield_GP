...
class ARP(IModule):
    ...
    def read_configuration(self):
        ...
        if self.delete_zeek_files:
            self.print(
                "Warning: smartshield will delete Zeek log files after "
    ...
    def check_arp_scan(self, profileid, twid, flow):
        ...
        randomly generated by smartshield
        """
    ...
    def set_evidence(self, evidence: Evidence):
        """the goal of this function is to discard evidence of other smartshield
        peers doing arp scans because that's smartshield attacking back attackers"""
    ...
    def main(self):
        ...
        if msg := self.get_msg("new_arp"):
            ...
            # are randomly generated by smartshield
