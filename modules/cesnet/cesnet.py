...
from smartshield_files.common.idea_format import (
    idea_format,
)
...
class CESNET(IModule):
    ...
    def read_configuration(self):
        """Read importing/exporting preferences from smartshield.yaml"""
        conf = ConfigParser()
    ...
    def import_alerts(self):
        ...
        for event in events:
            ...
            for srcip in srcips:
                # store the event info in a form recognizable by smartshield
                event_info = {
    ...
    def pre_main(self):
        ...
        self.node_info = [
            {"Name": self.wclient.name, "Type": ["IPS"], "SW": ["smartshield"]}
        ]
