...
from smartshield_files.core.structures.evidence import Direction
...
class DNS(IFlowalertsAnalyzer):
    def init(self):
        ...
        # after this number of arpa queries, smartshield will detect an arpa scan
    ...
    def should_detect_dns_without_conn(self, flow) -> bool:
        ...
        returns False in the following cases
         ...
         the ipwhois library in smartshield to get the ASN
    ...
    def check_dns_without_connection_of_all_pending_flows(self):
        ...
        flows in the pending_dns_without_conn queue before stopping smartshield,
    ...
    def check_pending_flows_timeout(
        ...
        :param reference_flow: the current DNS flow smartshield is nalayzing.
        ...
        try:
            while (
                ...
                if not reference_flow:
                    # ok wait for more dns flows to be read by smartshield
                    time.sleep(1)
                    continue
    ...
    def _is_ok_to_connect_to_ip_outside_localnet(self, flow) -> bool:
        ...
        for ip in (flow.saddr, flow.daddr):
            ...
            return (
                # if the ip is the dns server that smartshield detected,
