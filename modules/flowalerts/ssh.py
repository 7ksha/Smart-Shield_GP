...
class SSH(IFlowalertsAnalyzer):
    ...
    def detect_successful_ssh_by_smartshield(
        self, twid, conn_log_flow: dict, ssh_flow
    ):
        """
        Try smartshield method to detect if SSH was successful by
        ...
        # easier way to show how smartshield detected
    ...
    async def check_successful_ssh(self, twid, flow):
        ...
        if flow.auth_success in ["true", "T"]:
            ...
            self.detect_successful_ssh_by_smartshield(twid, conn_log_flow, flow)
