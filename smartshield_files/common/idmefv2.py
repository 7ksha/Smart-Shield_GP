...
class IDMEFv2:
    """
    Class to convert smartshield evidence and alerts to
    ...
    def __init__(self, logger: Output, db):
        ...
        self.db = db
        self.model: str = utils.get_smartshield_version()
    ...
    def convert_threat_level_to_idmefv2_severity(
        ...
        """
        converts smartshield threat level to a valid IDMEFv2 Severity value
    ...
    def extract_role_type(
        ...
        :param evidence: a smartshield Evidence object
        ...
        # map of smartshield victim types to IDMEF supported types
        type_ = {
            IoCType.IP.name: "IP",
    ...
    def convert_to_idmef_event(self, evidence: Evidence) -> Message:
        """
        Function to convert smartshield evidence to
