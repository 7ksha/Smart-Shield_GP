...
class IModule(ABC, Process):
    """
    An interface for all smartshield modules
    """
    ...
    def shutdown_gracefully(self):
        """
        Tells smartshield.py that this module is
