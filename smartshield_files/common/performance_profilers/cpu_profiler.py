...
from smartshield_files.common.abstracts.iperformance_profiler import (
...
class CPUProfiler(IPerformanceProfiler):
    def __init__(self, db, output, mode="dev", limit=20, interval=20):
        """
        :param output: the currently used smartshield output directory
        """
...
class DevProfiler(IPerformanceProfiler):
    ...
    def print(self):
        """
        Prints the profiling result to cpu_profiling_result in smartshield output
        directory
        """
