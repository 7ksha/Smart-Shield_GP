...
class AlertHandler:
    ...
    def is_detection_disabled(self, evidence_type: EvidenceType):
        """
        Function to check if detection is disabled in smartshield.yaml
        """
    ...
    def get_tw_limits(self, profileid, twid: str) -> Tuple[float, float]:
        ...
        if not twid_start_time:
            ...
            # tws in smartshield start from 1.
            #     tw1   tw2   tw3   tw4
            # 0 ──────┬─────┬──────┬──────
            #         │     │      │
            #         2     4      6
    ...
    def set_evidence(self, evidence: Evidence):
        ...
        smartshield_files/core/structures/evidence.py) with all the
        evidence details,
        """
    ...
    def init_evidence_number(self):
        ...
        evidence generated by smartshield"""
    ...
    def cache_whitelisted_evidence_id(self, evidence_id: str):
        ...
        alerts later
        """
        # without this function, smartshield gets the stored evidence id from the db,
