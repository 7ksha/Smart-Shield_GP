...
class Constants:
    ...
    smartshield_START_TIME = "smartshield_start_time"
    USED_FTP_PORTS = "used_ftp_ports"
    smartshield_INTERNAL_TIME = "smartshield_internal_time"
    IS_RUNNING_AS_AP = "is_smartshield_running_as_an_ap"
    WARDEN_INFO = "Warden"
    MODE = "mode"
    ANALYSIS = "analysis"
    ...
    WILL_smartshield_HAVE_MORE_FLOWS = "will_smartshield_have_more_flows"
