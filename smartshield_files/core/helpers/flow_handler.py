...
from smartshield_files.core.flows.suricata import SuricataFile
...
class FlowHandler:
    """
    Each flow seen by smartshield will be a different instance of this class
    """
    ...
    def handle_files(self):
        ...
        # files smartshield sees can be of 2 types: suricata or zeek
        to_send = {
            "flow": asdict(self.flow),
            "type": (
