...
from smartshield_files.common.abstracts.iwhitelist_analyzer import IWhitelistAnalyzer
...
class OrgAnalyzer(IWhitelistAnalyzer):
    ...
    def is_domain_in_org(self, domain: str, org: str) -> bool:
        ...
        try:
            ...
            # match subdomains of all org domains smartshield knows of
            ...
            # smartshield/organizations_info (not a famous org)
    ...
    def is_ip_in_org(self, ip: str, org):
        ...
        try:
            ...
            # info in smartshield/organizations_info (not a famous org)
            # and ip doesn't have asn info.
            pass
    ...
    def _is_asn_in_org(self, asn: str, org: str) -> bool:
        ...
        # because all ASN stored in smartshield organization_info/ are uppercase
        asn: str = asn.upper()
        if org.upper() in asn:
            return True
    ...
    def is_ip_part_of_a_whitelisted_org(self, ip: str, org: str) -> bool:
        ...
        smartshield_files/organizations_info
        """
