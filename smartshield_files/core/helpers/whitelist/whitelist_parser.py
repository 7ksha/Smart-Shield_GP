...
class WhitelistParser:
    ...
    def load_org_asn(self, org) -> Optional[List[str]]:
        """
        Reads the specified org's asn from smartshield_files/organizations_info
    ...
    def load_org_ips(self, org) -> Optional[Dict[str, List[str]]]:
        """
        Reads the specified org's info from smartshield_files/organizations_info
        and stores the info in the database
        ...
        try:
            ...
            # there's no smartshield_files/organizations_info/{org} for this org
            return
    ...
    def parse(self) -> bool:
        """parses the whitelist specified in the smartshield.yaml"""
        line_number = 0
