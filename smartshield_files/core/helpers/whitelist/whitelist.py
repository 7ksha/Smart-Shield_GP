...
from smartshield_files.core.helpers.whitelist.domain_whitelist import DomainAnalyzer
from smartshield_files.core.helpers.whitelist.ip_whitelist import IPAnalyzer
from smartshield_files.core.helpers.whitelist.mac_whitelist import MACAnalyzer
from smartshield_files.core.helpers.whitelist.matcher import WhitelistMatcher
from smartshield_files.core.helpers.whitelist.organization_whitelist import (
    OrgAnalyzer,
)
from smartshield_files.core.helpers.whitelist.whitelist_parser import WhitelistParser
...
class Whitelist:
    ...
    def update(self):
        """
        parses the local whitelist specified in the smartshield.yaml
