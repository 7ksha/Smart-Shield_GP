...
"""
Contains evidence dataclass that is used in smartshield
"""
...
class EvidenceType(Enum):
    """
    These are the types of evidence smartshield can detect
    """
...
class Victim:
    ...
    # if the victim is part of a TI feed that smartshield knows  about,
