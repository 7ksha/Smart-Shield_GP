...
"""
Contains alert dataclass that is used in smartshield
...
class Alert:
    profile: ProfileID
    # this should have the fields start_Time and end_time set
    ...
    def __post_init__(self):
        ...
        if not self.confidence:
            ...
            # ranging from 0 to 1
            # this means that the more evidence smartshield generates the more
