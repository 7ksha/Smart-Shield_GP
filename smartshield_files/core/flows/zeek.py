...
class Conn(BaseFlow):
    ...
    def __post_init__(self) -> None:
        ...
        # happens in zeek v7.1.0, set it to empty so it doesn't break smartshield
...
class Notice(BaseFlow):
    ...
    # default, smartshield adds one to them to be able to deal with it.
    type_: str = "notice"
    ...
    def __post_init__(self) -> None:
        ...
        if not self.daddr:
            ...
            # a dst field and smartshield needs it to work
